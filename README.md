...
* "What's the single most important thing a user does in this product. Step by step."
* "What would you need to see in a working prototype to know this idea works?"
* "Are there hard constraints I should know about?"

The output is three artifacts: 
* a readme.md
* an initial CLAUDE.md context file
